...
```
Se puede observar que las variables con mayor correlación son "sqft_above" y "sqft_living" Las correlaciones entre "sqft_living" y "sqft_living15" se debe a que "sqft_living15" se trata de la misma variable actualizada para 2015. La variable "price" como es de esperar es correlativa con "sqft_living" y "sqft_living15". Encontramos una correlación sorprendente entre "yr_built" y "sqft_above".
...
Se estudian las correlaciones entre las variables "bedrooms", "bathrooms","condition" y "grade" ya que el resto son irrelevantes.
