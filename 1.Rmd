...
```
Se puede observar que las variables con mayor correlación son __"sqft_above"__ y __"sqft_living"__ Las correlaciones entre __"sqft_living"__ y __"sqft_living15"__ se debe a que __"sqft_living15"__ se trata de la misma variable actualizada para 2015. La variable __"price"__ como es de esperar es correlativa con __"sqft_living"__ y __"sqft_living15"__ incluso más que __"price_m2"__. Encontramos una correlación sorprendente entre __"yr_built"__ y __"sqft_above"__.
...
Estudiamos la relación entre la variable __"price_m2"__ y la variable __"Dist_from_seattle"__
...
Se estudia la relación entre la variable __"Dist_from_seattle"__ y __"price"__

```{r}
ggplot(train,aes(x=Dist_from_seattle,y=price))+geom_point()+geom_smooth()

```
A pesar de ser menor la correlación, la distribución explica más sobre del precio de la vivienda.

Se estudia la relación entre cada uno de los Clusters y la variable __"price"__
...
Se estudian las correlaciones entre las variables cualitativas "bedrooms", "bathrooms","condition","grade".
